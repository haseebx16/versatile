  ...
  return (
    ...
    >
      <section className="md:w-[50%] md:pt-0 pt-12  w-full">
        <div>
          <p data-aos="fade-right" className="md:text-3xl text-customPurple text-2xl text-cards">Expert Development Teams</p>
          <h1 data-aos="fade-down" className="md:text-5xl text-3xl font-bold text-black mt-6">
            Improving The Code Base, Frameworks & Languages Through Development.
          </h1>
          <p data-aos="fade-up" className="text-md text-black mt-6">
            At Versatile Marketers, our agile and multi-disciplinary Development teams
            have a well-defined methodology to deliver high-quality results. Our
            expertise spans a wide range of development tools & languages.
          </p>
