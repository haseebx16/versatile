...
const page = () => {
  ...
  return (
    ...
    >
      ...
      <div>
          <p className="md:text-5xl text-2xl uppercase text-customPurple">Hire the best Graphics Designers</p>
          <p className="text-3xl text-black font-bold mt-6">
          Transform Your Business with Top-Notch Graphics Designing Skills - Hire the Best Graphics Designers Today
          </p>
      ...
      <section className="md:w-[50%] md:pt-0 pt-12 z-20 w-full">
        <div>
          ...
          Are you in need of a skilled Graphics Designer or team to bring your design idea to life? Look no further than Versatile Marketers.
          </p>
