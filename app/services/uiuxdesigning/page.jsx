...
const page = () => {
  ...
  return (
    ...
    >
      ...
      <div>
          <p className="md:text-5xl text-2xl uppercase text-customPurple">Hire the best Designers</p>
          <p className="text-3xl text-black font-bold mt-6">
          Transform Your Business with Top-Notch Designing Skills - Hire the Best Designers Today
          </p>
